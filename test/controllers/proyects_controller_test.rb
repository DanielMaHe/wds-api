...
class ProyectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create proyect" do
    assert_difference("Proyect.count") do
      post proyects_url, params: { proyect: { comment: @proyect.comment, company: @proyect.company, status: @proyect.status } }, as: :json
    end
  ...
  test "should update proyect" do
    patch proyect_url(@proyect), params: { proyect: { comment: @proyect.comment, company: @proyect.company, status: @proyect.status } }, as: :json
    assert_response :success
  end
