...
Worker.create(username:"worker Admin",mail:"workerAdmin@mail.com",isAdmin:true, password: "qwerty", password_confirmation: "qwerty")
Worker.create(username:"worker 1",mail:"worker1@mail.com",isAdmin:false, password: "qwerty", password_confirmation: "qwerty")
Worker.create(username:"worker 2",mail:"worker2@mail.com",isAdmin:false, password: "qwerty", password_confirmation: "qwerty")
